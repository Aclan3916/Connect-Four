    ...
    for (var i = 0, len = squares.length; i < len; i++)
        ...
        function checkBoard() {
            const winningArrays = [
                ...
                //now take the 4 values in each winningArrays and plug them into the sqaures 
                for(let y=0; y < winningArrays.length; y++)
                {
                    ...
                    {
                        //if true, player-one is the winner
                    ...
                    // if (result.innerHTML === "Player Two Wins!" || result.innerHTML === "Player One Wins!")
                    // {
        ...
        //add an EventListener to each square that will trigger the checkBaord function on click 
        //this means the function will run everytime you press on a square in the div grid
